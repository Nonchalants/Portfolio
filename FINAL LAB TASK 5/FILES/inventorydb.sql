...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`P_CODE`),
  KEY `FK_VCode` (`V_CODE`),
  CONSTRAINT `FK_VCode` FOREIGN KEY (`V_CODE`) REFERENCES `vendors` (`V_CODE`) ON UPDATE CASCADE
...
--
-- Temporary view structure for view `view_products_price_range`
--

DROP TABLE IF EXISTS `view_products_price_range`;
/*!50001 DROP VIEW IF EXISTS `view_products_price_range`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_products_price_range` AS SELECT 
 1 AS `P_CODE`,
 1 AS `P_DESCRIPT`,
 1 AS `P_INDATE`,
 1 AS `P_ONHAND`,
...
--
-- Temporary view structure for view `view_total_price_selected_vendors`
--

DROP TABLE IF EXISTS `view_total_price_selected_vendors`;
/*!50001 DROP VIEW IF EXISTS `view_total_price_selected_vendors`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_total_price_selected_vendors` AS SELECT 
 1 AS `V_CODE`,
 1 AS `V_NAME`,
 1 AS `P_DESCRIPT`,
 1 AS `TOTAL_PRICE`*/;
...
/*!50001 VIEW `view_products_2002_onwards` AS select `v`.`V_CODE` AS `vendor_code`,`v`.`V_NAME` AS `vendor_name`,`p`.`P_DESCRIPT` AS `product_description`,`p`.`P_INDATE` AS `P_INDATE` from (`products` `p` join `vendors` `v` on(`p`.`V_CODE` = `v`.`V_CODE`)) where year(`p`.`P_INDATE`) >= 2002 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view_products_price_range`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_total_price_selected_vendors` AS select `p`.`V_CODE` AS `V_CODE`,`v`.`V_NAME` AS `V_NAME`,`p`.`P_DESCRIPT` AS `P_DESCRIPT`,`p`.`P_ONHAND` * `p`.`P_PRICE` AS `TOTAL_PRICE` from (`products` `p` join `vendors` `v` on(`p`.`V_CODE` = `v`.`V_CODE`)) where `p`.`V_CODE` in (21344,23119,24288) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-05-15 18:47:08
